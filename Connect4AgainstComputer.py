        ...
        try:
            if isFull(board):                   
                if player == 1:
                    ...
                    compCol = random.choice(compChoices)
                    if board[compCol] != '_':
                        compChoices.remove(compCol)
                        compCol = random.choice(compChoices)
                        bot = compCol + 35
                        print(f'Computer, play: {compCol + 1}')
                        computerMove(board, bot, compCol)
